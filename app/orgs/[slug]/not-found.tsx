...
export default function OrgNotFound() {
  return (
    <div className="min-h-screen bg-ink-50 flex flex-col items-center justify-center text-center px-6">
      ...
      <h1 className="text-2xl font-semibold text-ink-900 mb-2">Organization not found</h1>
      <p className="text-sm text-ink-500 mb-8 max-w-xs">
        This organization doesn&apos;t exist on Merit. Double-check the link and try again.
      </p>
      <Link
        href="/"
