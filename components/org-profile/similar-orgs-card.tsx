  ...
  if (loading) {
    return (
      <div className="bg-card rounded-xl border border-border p-5">
        <h2 className="text-[15px] font-semibold text-foreground mb-4">You might also like</h2>
        ...
        {orgs.map((org) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[13px] font-semibold text-foreground group-hover:text-merit-blue-600 transition-colors truncate">
                {org.name}
              </p>
